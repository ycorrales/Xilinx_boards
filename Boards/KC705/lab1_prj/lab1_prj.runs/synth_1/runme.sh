...
HD_PWD='/home/l329869/vhdl_tutorial/debug_tutorial/test_projects/lab1_prj/lab1_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinegen_demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sinegen_demo.tcl
