...
HD_PWD='/home/l329869/vhdl_tutorial/debug_tutorial/test_projects/lab1_prj/lab1_prj.runs/sine_high_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_high.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sine_high.tcl
