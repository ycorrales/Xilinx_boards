...
#
# Generated by Vivado on Fri May 22 21:02:05 MDT 2020
...
# Script info
echo -e "sine_mid.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./sine_mid.sh -help\" for more information)\n"
  exit 1
fi
